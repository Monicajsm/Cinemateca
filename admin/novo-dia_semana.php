<?php
	...
	if(isSet($_POST['enviar']) && $_POST['enviar']!=''){
		...
		if (!empty($dia)) {
			...
			// Query de insercao
			$inserir = $mysqli->query("INSERT INTO `dia_semana` (
				`id`,
				`dia`
				) VALUES (
				default,
...
<html>
<head>
	<title>Backend - Novo Dia da Semana</title>
...
<body class="body">	
	...
	<section class="cabecalho">
		<h1 class="titulo-crm">NOVO DIA</h1>
		<h6 class="descricao-crm">Aqui adicionamos um novo dia da semana.</h6>
	</section>
