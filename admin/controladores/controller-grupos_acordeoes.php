<?php  
	...
	if (isset($_GET['accao']) && $_GET['accao'] == 'apagar') {
		$control = true;
		if (isset($_GET['id'])) {
			$grupoACORDEOES = $_GET['id'];
			$apagar = $mysqli->query("DELETE FROM `grupos_acordeoes` WHERE `id` = '$grupoACORDEOES'");

			$sms = 'Grupo de acordeões apagado com sucesso!';
			$retorno = '../grupos_acordeoes.php?sms='.$sms;
