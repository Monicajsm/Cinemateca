...
if (isset($_POST['enviar']) && $_POST['enviar'] != '') {
	...
	if (!empty($img)) {
			...
			$inserir = $mysqli->query("INSERT INTO `banners_paginas` (
				`id`,
				`url`
				) VALUES (
				default,
...
<body class="body">	
	...
	<section class="cabecalho">
		<h1 class="titulo-crm">NOVO BANNERS DAS PAGINAS</h1>
		<h6 class="descricao-crm">Aqui adicionamos informação para criar novos banners das paginas do site.</h6>
	</section>
