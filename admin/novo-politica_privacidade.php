...
if (isset($_POST['enviar']) && $_POST['enviar'] != '') {
	...
	if (!empty($titulo) && !empty($conteudo) && !empty($erroIMG)) {
			...
			$inserir = $mysqli->query("INSERT INTO `politicadeprivacidade` (
				`id`,
				`titulo`,
				`conteudo`,
				`img`
...
<body class="body">	
	...
	<section class="cabecalho">
		<h1 class="titulo-crm">NOVO POLÍTICA DE PRIVACIDADE</h1>
		<h6 class="descricao-crm">Nova informação para a Política de Privacidade do site.</h6>
	</section>
